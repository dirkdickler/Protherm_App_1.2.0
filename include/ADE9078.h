...
uint16_t ADE9078_GetVersion(void);
...
#define regADE_CONFIG0                0x0060
#define regADE_AVRMS                  0x020D
#define regADE_AIRMS                  0x020C
#define regADE_BVRMS                  0x022D
#define regADE_BIRMS                  0x022C
#define regADE_CVRMS                  0x024D
#define regADE_CIRMS                  0x024C
#define regADE_VLEVEL                 0x040F
#define regADE_RUN                    0x0480

#define regADE_ZX_LP_SEL			  0x049A
#define regADE_CONFIG5                0x04A4
#define regADE_CONFIG2				  0x04AF	
#define regADE_PGA_GAIN				  0x04B9	
#define regADE_versio_IC              0x04FE

#define regADE_AV_SINC_DAT		      0x0501 //Ua 16kksp
#define regADE_AV_LPF_DAT		      0x0511 //Ua LPF 4ksp
#define regADE_CV_LPF_DAT		      0x0515 //Uc LPF 4ksp
